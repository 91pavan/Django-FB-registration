# Django settings for fbreg project.
...
ROOT_URLCONF = 'fbreg.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fbreg.wsgi.application'

TEMPLATE_DIRS = ('C:/Users/Pavan/PycharmProjects/fbreg/templates',)
